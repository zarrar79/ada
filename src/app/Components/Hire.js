        ...
        <div className='max-w-[1231px] mx-auto mt-[86px] overflow-hidden'>
             ...
             <div>
                ...
                <div className='flex justify-center items-center mt-[34px]'> 
                    ...
                    {/* button 3 */}
                    <div><button className='boxshadow_hire bg-[#E3D4FC] ml-8 border-[2px] border-[#E3D4FC] py-1 px-4 rounded-[16px] font-[600] text-[14px] text-[#1E232E]'>Coach</button></div>
                </div>
             </div>
             {/* text + center */}
             {/* grid */}
             <div className='grid grid-cols-2 mt-[3rem] items-center'>
                {/* left */}
                <div>
                    {/* head */}
                    <div className='leading-[46px] font-[900] text-[40px] text-[#1e232e]'>Automatically resolve up to 75% of customer inquiries</div>
                    {/* sm-text */}
